twoSum --> Find indices of two numbers in an array that add up to a target.

Best Time to Buy and Sell Stock --> Calculate the maximum profit by choosing the best day to buy and sell stock using a greedy one-pass algorithm.
